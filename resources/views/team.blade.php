...
@section('content')
    <div class="banner mt-4">
        <img src="{{asset('assets/images/banner.jpg')}}" class="w-full lg:h-[400px] md:h-[400px] sm:h-[400px] h-[200px] object-cover" alt="">
    </div>

    <div class="banner py-16 px-2 bg-white">
        <div class="max-w-[1200px] mx-auto grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1">
            <div class="flex flex-col items-center">
                ...
                <div class="w-full mt-4">
                    <span class="text-primary lg:text-xl text-md font-semibold">Awards and Honors</span>
                    <p class="text-sm mt-4">•	Invited speaker in
                    ...
                    <p class="text-sm mt-4">•	Invited speaker at the
                        <strong class="text-primary">6th Cryo-EM symposium (2021), Yale University</strong>, NH, USA
                    </p>
                    <p class="text-sm mt-4">•	BPS (USA) travel award (2021)
                    </p>
                    <p class="text-sm mt-4">•	EMBO travel grant (2017)
                    </p>
                    <p class="text-sm mt-4">•	DBT travel grant (2018)
                    </p>
    ...
    <div class="banner py-16 px-2">
        <div class="max-w-[1200px] mx-auto lg:grid md:grid flex flex-col-reverse lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4">
            <div class="w-full flex flex-col items-center">
                <p class="text-center lg:text-md md:text-md sm:text-md text-sm mt-8 font-[200]">Embarking on a journey through biotechnology, I pursued my Bachelor of Science in Biotechnology at Panjab University, Chandigarh, from 2018 to 2021, achieving an 87% aggregate. In 2021, my academic journey was marked by several significant achievements in national-level examinations:</p>
                <ul class="mt-4">
                    <li class="font-[200]"><strong>•	GAT-B: </strong> Secured an All India Rank (AIR) of 25.</li>
                    <li class="font-[200]"><strong>•	PGIMER Biochemistry Entrance:  </strong> Achieved AIR 8.</li>
                    <li class="font-[200]"><strong>•	TIFR-JGEEBILS:  </strong>Qualified successfully.</li>
                    <li class="font-[200]"><strong>•	GATE-XL:  </strong> Obtained AIR 588.</li>
                    <li class="font-[200]"><strong>•	GATE-BT: </strong> Secured AIR 1195.</li>
                    <li class="font-[200]"><strong>•	IIT-JAM:  </strong>Achieved AIR 331, facilitating my admission into the Master of Science program at the National Institute of Technology (NIT), Rourkela.</li>
                </ul>

                <p class="text-center lg:text-md md:text-md sm:text-md text-sm mt-8 font-[200]">At NIT Rourkela, I pursued my Master's in Life Sciences from 2021 to 2023, graduating with a  CGPA of 9.36. During the summer of 2022, I undertook a two-month research internship at the CSIR-Centre for Cellular and Molecular Biology (CCMB) in Hyderabad, under the mentorship of Dr. Mohammed Idris. This internship provided me with hands-on experience in molecular biology techniques and deepened my understanding of developmental processes. For my Master's dissertation, I worked under the guidance of Dr. Bibekanand Mallick at NIT Rourkela. My research focused on investigating the role of small non-coding RNAs in cancer treatment, aiming to elucidate their potential as therapeutic agents in oncology. In 2022, I once again qualified for GATE-XL and got admission to IIT Roorkee as a Ph.D. student, which I commenced in 2023. My doctoral research is on the structural and functional aspects of cardiac myosin-binding protein-C, a crucial sarcomeric regulatory protein. This research holds significant implications for understanding cardiac muscle physiology and potential therapeutic interventions for cardiac diseases. </p>
            </div>
            <div class="flex flex-col items-center">
                <img src="{{asset('assets/images/saloni.jpg')}}" class="lg:h-96 md:h-96 sm:h-72 h-64 w-auto rounded-[3px]" alt="">
                <span class="lg:text-3xl md:text-3xl sm:text-2xl text-2xl text-primary mt-4">Saloni Garg</span>
                <span class="lg:text-md md:text-md sm:text-md text-sm font-[200]">PhD Student</span>
            </div>
    ...
    <div class="banner py-16 px-2 bg-white">
        <div class="max-w-[1200px] mx-auto grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1">
            <div class="flex flex-col items-center">
                ...
                <span class="lg:text-3xl md:text-3xl sm:text-2xl text-2xl text-primary mt-4">Rohit Singh</span>
                <span class="lg:text-md md:text-md sm:text-md text-sm font-[200]">PhD Student</span>
            </div>
            <div class="w-full flex flex-col items-center">
                <p class="text-center lg:text-md md:text-md sm:text-md text-sm mt-8 font-[200]">I obtained my Bachelor's degree in Zoology, Botany, and Chemistry from Kumaon University, Almora, and my Master's degree in Zoology from SSJ University, Almora. During my Master's, I worked on identifying and evaluating potential enzyme inhibitors through in vivo and silico studies.</p>
                <p class="text-center lg:text-md md:text-md sm:text-md text-sm mt-8 font-[200]">I qualified for the CSIR-UGC NET Junior Research Fellowship exam with an All-India Rank of 51 and joined Dr. Prince Tiwari’s lab at IIT Roorkee as a researcher in February  2024. My research focuses on the biophysical and structural aspects of M-band proteins in the sarcomere.  </p>
                <p class="text-center lg:text-md md:text-md sm:text-md text-sm mt-8 font-[200]">Outside the lab, I enjoy watching movies and playing tennis.  </p>
            </div>
        </div>
    ...
    <div class="banner py-16 px-2 bg-white">
        <div class="max-w-[1200px] mx-auto grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1">
            <div class="flex flex-col items-center">
                ...
                <span class="lg:text-3xl md:text-3xl sm:text-2xl text-2xl text-primary mt-4">Kaushiki Tiwari </span>
                <span class="lg:text-md md:text-md sm:text-md text-sm font-[200]">PhD Student</span>
            </div>
            <div class="w-full flex flex-col items-center">
                <p class="text-center lg:text-md md:text-md sm:text-md text-sm mt-8 font-[200]">I received my bachelor’s degree in microbiology from the University of Delhi (2017-2020). During my undergraduate studies, I completed an internship at the Dr. Ram Manohar Lohia (RML) Institute of Medical Sciences, Lucknow. In 2020, I qualified for GAT-B and subsequently pursued a master’s degree in biotechnology at the University of Mysore (2020-2022). Throughout my academic journey, I developed a strong interest in structural biology and protein biochemistry. To further explore this field, I joined the Molecular Reproduction and Developmental Genetics (MRDG) lab at IISc Bangalore for my dissertation, where I gained valuable research experience.</p>
                <p class="text-center lg:text-md md:text-md sm:text-md text-sm mt-8 font-[200]">In 2023, I qualified for GATE BT and joined my current lab as a PhD student, where I am working on the structural and functional aspects of cardiac myosin-binding protein-C (cMyBP-C), a sarcomeric regulatory protein. </p>
                <p class="text-center lg:text-md md:text-md sm:text-md text-sm mt-8 font-[200]">Outside the lab, I enjoy playing badminton, cooking and watching movies.  </p>
            </div>
        </div>
    ...
    <div class="py-20 px-2 flex flex-col items-center ">
        <span class="text-primary lg:text-3xl md:text-3xl sm:text-2xl text-2xl">Other Members</span>
    ...
    <div class="py-20 px-2 flex flex-col items-center bg-white">
        <span class="text-primary lg:text-3xl md:text-3xl sm:text-2xl text-2xl">Past Members</span>
        <div class="max-w-[800px]">
            <table class="w-full mt-8">
                <tr>
                    <td class="px-6">1</td>
                    <td class="px-6">Alka Kumari </td>
                    <td class="px-6">B.Tech project </td>
                    <td class="px-6">2024</td>
                </tr>
                <tr>
                    <td class="px-6">2</td>
                    <td class="px-6">Abhishek Jha  </td>
                    <td class="px-6">MSc- thesis</td>
                    <td class="px-6">2024</td>
                </tr>
                <tr>
                    <td class="px-6">3</td>
                    <td class="px-6">Shaleen Singh  </td>
                    <td class="px-6">B.Tech project </td>
                    <td class="px-6">2023</td>
                </tr>
                <tr>
                    <td class="px-6">4</td>
                    <td class="px-6">Nisha Dhanda </td>
                    <td class="px-6">MSc thesis</td>
                    <td class="px-6">2023</td>
                </tr>
